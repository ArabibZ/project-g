...
as $$
  ...
  left join auth.sessions as auth_session
    on auth_session.id = p_session_id
...
revoke all on function public.authorize_admin_session(uuid, uuid)
from public, anon, authenticated;
grant execute on function public.authorize_admin_session(uuid, uuid)
to service_role;
